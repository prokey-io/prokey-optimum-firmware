...
void layoutProgressUpdate(bool refresh) {
  static uint8_t step = 0;
	switch (step) {
		case 0:
			oledDrawBitmap(40, 0, &bmp_prg1);
			break;
		case 1:
			oledDrawBitmap(40, 0, &bmp_prg2);
			break;
		case 2:
			oledDrawBitmap(40, 0, &bmp_prg3);
			break;
		case 3:
			oledDrawBitmap(40, 0, &bmp_prg4);
			break;
		case 4:
			oledDrawBitmap(40, 0, &bmp_prg45);
			break;
		case 5:
			oledDrawBitmap(40, 0, &bmp_prg90);
			break;
		case 6:
			oledDrawBitmap(40, 0, &bmp_prg125);
			break;
	}
	step = (step + 1) % 6;
	if (refresh) {
