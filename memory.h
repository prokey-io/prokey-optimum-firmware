...
/*
 ...
 Prokey Flash memory layout:

   name    |          range          |  size   |     function
-----------+-------------------------+---------+------------------
 Sector  0 | 0x08000000 - 0x08003FFF |  16 KiB | First Boot
-----------+-------------------------+---------+------------------
 Sector  1 | 0x08004000 - 0x08007FFF |  16 KiB | Reserved
-----------+-------------------------+---------+------------------
 Sector  2 | 0x08008000 - 0x0800BFFF |  16 KiB | metadata area
 Sector  3 | 0x0800C000 - 0x0800FFFF |  16 KiB | metadata area
-----------+-------------------------+---------+------------------
 Sector  4 | 0x08010000 - 0x0801FFFF |  64 KiB | Bootloader
-----------+-------------------------+---------+------------------
...
#define FLASH_FIRST_BOOT_START 0x08000000
#define FLASH_FIRST_BOOT_LEN   (0x4000)

#define FLASH_RESERVE_START	0x08004000
#define FLASH_RESERVE_LEN   (0x4000)

#define FLASH_STORAGE_START 0x08008000
#define FLASH_STORAGE_LEN (0x8000)

#define FLASH_BOOT_START 0x08010000
#define FLASH_BOOT_LEN (0x10000)

#define FLASH_APP_START 0x08020000
#define FLASH_APP_LEN (FLASH_TOTAL_SIZE - (FLASH_APP_START - FLASH_ORIGIN))

#define FLASH_FIRST_BOOT_SECTOR_FIRST 0
#define FLASH_FIRST_BOOT_SECTOR_LAST  0

#define FLASH_STORAGE_SECTOR_FIRST 2
#define FLASH_STORAGE_SECTOR_LAST 3

#define FLASH_BOOT_SECTOR_FIRST 4
#define FLASH_BOOT_SECTOR_LAST 4

#define FLASH_CODE_SECTOR_FIRST 5
