...
#define USB_STRINGS                                 \
  X(MANUFACTURER, "Prokey.io")                    \
  X(PRODUCT, "Prokey Optimum")                              \
  X(SERIAL_NUMBER, config_uuid_str)                 \
  X(INTERFACE_MAIN, "Prokey Interface")             \
  X(INTERFACE_DEBUG, "Prokey Debug Link Interface") \
  X(INTERFACE_U2F, "Prokey U2F Interface")
...
void usbInit(void) {
  ...
  static const char *origin_url = "prokey.io";
